...
\begin{block}{Goal}
\justifying\small 
To use the Landsat 8 satellite for the retrieval of color producing agents (CPAs) (chlorophyll-{\it a}, sediments (total suspended solid or TSS) and colored dissolved organic matter (CDOM)) over inland and coastal waters (Case 2 Waters). 
\end{block}
%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[htbp!]
  \centering
  \includegraphics[width=16cm]{/Users/javier/Desktop/Javier/PHD_RIT/ConferencesAndApplications/2015_Landsat_Special_Issue/Images/ROI130919_150422}
