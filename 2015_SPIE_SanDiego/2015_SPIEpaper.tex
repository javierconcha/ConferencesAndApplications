...
The first chlorophyll-{\it a} retrieval algorithm was the algorithm developed by Concha and Schott\cite{Concha2013IGARSS}. This algorithm was applied to the MoB-ELM results only.
% -----------------------------------------------------------
...
\begin{figure}[htbp!]
  \begin{minipage}[c]{1.0\linewidth}
    	...
    	\put(17,65){\includegraphics[trim=10 80 0 0,clip,width=4.5cm]{./Images/CHLmeavsretZOOM.png}}
      \end{overpic}  
  \end{minipage}
