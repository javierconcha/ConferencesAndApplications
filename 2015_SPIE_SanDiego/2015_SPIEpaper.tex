...
\autoref{fig:13262RrsCompField} shows a comparison between $R_{rs}$ spectra measured in the field with retrieved $R_{rs}$ spectra from the four atmospheric correction methods.
...
% 
  \caption{Comparison of $R_{rs}$ for the sites on the 90-19-2013 collection. \label{fig:13262RrsCompField}} 
\end{figure}
