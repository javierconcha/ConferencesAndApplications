...
\setbeamertemplate{headline}{}
	...
	\begin{textblock*}{\linewidth}(0cm,0cm)
	   \center\scriptsize Presented to: Optical Oceanography Lab, UMass Boston
	\end{textblock*}
...
\setbeamercovered{transparent}
    \uncover<2->{
	\item Two kinds of atmospheric algorithms were tested: MoB-ELM (RIT) and Gordon and Wang's (NASA)}
	\uncover<3->{
...
\begin{figure}[htb]
\centering
\includegraphics[height=6cm]{/Users/javier/Desktop/Javier/PHD_RIT/ConferencesAndApplications/2015_SPIE_SanDiego/Images/AlgaBloom}
\end{figure}
\vspace{-.3cm}
