...
% Title.
% ------
\title{AUTHOR GUIDELINES FOR IGARSS 2013 PROCEEDINGS MANUSCRIPTS}
%
% Single address.
% ---------------
...
All halftone illustrations must be clear black and white prints. Color may be
used, but it should be clear when printed on a black-only printer.
